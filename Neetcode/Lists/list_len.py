...
check_element_in_list(my_list, element) -> bool should return a boolean representing whether the element is present in the list or not. 
The list may contain integers or strings.
'''
